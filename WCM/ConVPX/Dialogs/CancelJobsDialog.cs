namespace WCM.ConVPX.Dialogs
{
	...
	public class CancelJobsDialog : DialogBase
    {
        private List<ConVpxJobInfo> _availJobs;
        private DoCancelJobsTask _worker;
        ...
        public CancelJobsDialog(List<ConVpxJobInfo> availJobs) : this()
        {
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(CancelJobsDialog));
        ...
        private void OKButton2_Click(object sender, EventArgs e)
        {
            ...
            {
                this._worker = new DoCancelJobsTask(Program.ClientConnection, selectedJobsToCancel);
                this._worker.Completed += new CancelJobsCompletedEventHandler(this.worker_Completed);
                this._worker.Start();
