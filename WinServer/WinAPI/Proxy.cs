namespace WinAPI
{
    ...
    public interface Proxy : IXmlRpcProxy
    {
        ...
        Response<string> async_bond_destroy(string session, string _bond);
        [XmlRpcMethod("Async.Bond.set_mode")]
        Response<string> async_bond_set_mode(string session, string _bond, string _value);
        [XmlRpcMethod("Async.Bond.set_property")]
        Response<string> async_bond_set_property(string session, string _bond, string _name, string _value);
        ...
        Response<string> async_crashdump_destroy(string session, string _crashdump);
        ...
        Response<string> async_dr_task_destroy(string session, string _dr_task);
        [XmlRpcMethod("Async.GPU_group.create")]
        Response<string> async_gpu_group_create(string session, string _name_label, string _name_description, object _other_config);
        [XmlRpcMethod("Async.GPU_group.destroy")]
        Response<string> async_gpu_group_destroy(string session, string _gpu_group);
        [XmlRpcMethod("Async.GPU_group.get_remaining_capacity")]
        Response<string> async_gpu_group_get_remaining_capacity(string session, string _gpu_group, string _vgpu_type);
        ...
        Response<string> async_host_crashdump_destroy(string session, string _host_crashdump);
        [XmlRpcMethod("Async.host_crashdump.upload")]
        Response<string> async_host_crashdump_upload(string session, string _host_crashdump, string _url, object _options);
        ...
        Response<string> async_host_declare_dead(string session, string _host);
        [XmlRpcMethod("Async.host.destroy")]
        Response<string> async_host_destroy(string session, string _host);
        ...
        Response<string> async_host_disable_display(string session, string _host);
        ...
        Response<string> async_host_enable_display(string session, string _host);
        ...
        Response<string> async_host_get_uncooperative_resident_vms(string session, string _host);
        [XmlRpcMethod("Async.host.get_vms_which_prevent_evacuation")]
        Response<string> async_host_get_vms_which_prevent_evacuation(string session, string _host);
        ...
        Response<string> async_host_patch_apply(string session, string _host_patch);
        [XmlRpcMethod("Async.host_patch.destroy")]
        Response<string> async_host_patch_destroy(string session, string _host_patch);
        ...
        Response<string> async_host_retrieve_wlb_evacuate_recommendations(string session, string _host);
        ...
        Response<string> async_host_set_power_on_mode(string session, string _host, string _power_on_mode, object _power_on_config);
        [XmlRpcMethod("Async.host.set_ssl_legacy")]
        Response<string> async_host_set_ssl_legacy(string session, string _host, bool _value);
        ...
        Response<string> async_lvhd_enable_thin_provisioning(string session, string _sr, string _initial_allocation, string _allocation_quantum);
        ...
        Response<string> async_pbd_plug(string session, string _pbd);
        [XmlRpcMethod("Async.PBD.set_device_config")]
        Response<string> async_pbd_set_device_config(string session, string _pbd, object _value);
        [XmlRpcMethod("Async.PBD.unplug")]
        Response<string> async_pbd_unplug(string session, string _pbd);
        [XmlRpcMethod("Async.PGPU.add_enabled_VGPU_types")]
        Response<string> async_pgpu_add_enabled_vgpu_types(string session, string _pgpu, string _value);
        [XmlRpcMethod("Async.PGPU.disable_dom0_access")]
        Response<string> async_pgpu_disable_dom0_access(string session, string _pgpu);
        [XmlRpcMethod("Async.PGPU.enable_dom0_access")]
        Response<string> async_pgpu_enable_dom0_access(string session, string _pgpu);
        [XmlRpcMethod("Async.PGPU.get_remaining_capacity")]
        Response<string> async_pgpu_get_remaining_capacity(string session, string _pgpu, string _vgpu_type);
        [XmlRpcMethod("Async.PGPU.remove_enabled_VGPU_types")]
        Response<string> async_pgpu_remove_enabled_vgpu_types(string session, string _pgpu, string _value);
        [XmlRpcMethod("Async.PGPU.set_enabled_VGPU_types")]
        Response<string> async_pgpu_set_enabled_vgpu_types(string session, string _pgpu, string[] _value);
        [XmlRpcMethod("Async.PGPU.set_GPU_group")]
        Response<string> async_pgpu_set_gpu_group(string session, string _pgpu, string _value);
        ...
        Response<string> async_pif_db_forget(string session, string _pif);
        ...
        Response<string> async_pif_destroy(string session, string _pif);
        [XmlRpcMethod("Async.PIF.forget")]
        Response<string> async_pif_forget(string session, string _pif);
        ...
        [XmlRpcMethod("Async.PIF.introduce")]
        Response<string> async_pif_introduce(string session, string _host, string _mac, string _device, bool _managed);
        [XmlRpcMethod("Async.PIF.plug")]
        Response<string> async_pif_plug(string session, string _pif);
        [XmlRpcMethod("Async.PIF.reconfigure_ip")]
        Response<string> async_pif_reconfigure_ip(string session, string _pif, string _mode, string _ip, string _netmask, string _gateway, string _dns);
        [XmlRpcMethod("Async.PIF.reconfigure_ipv6")]
        Response<string> async_pif_reconfigure_ipv6(string session, string _pif, string _mode, string _ipv6, string _gateway, string _dns);
        ...
        Response<string> async_pif_set_primary_address_type(string session, string _pif, string _primary_address_type);
        [XmlRpcMethod("Async.PIF.set_property")]
        Response<string> async_pif_set_property(string session, string _pif, string _name, string _value);
        [XmlRpcMethod("Async.PIF.unplug")]
        Response<string> async_pif_unplug(string session, string _pif);
        [XmlRpcMethod("Async.pool.add_to_guest_agent_config")]
        Response<string> async_pool_add_to_guest_agent_config(string session, string _pool, string _key, string _value);
        [XmlRpcMethod("Async.pool.apply_edition")]
        Response<string> async_pool_apply_edition(string session, string _pool, string _edition);
        ...
        Response<string> async_pool_disable_local_storage_caching(string session, string _pool);
        ...
        Response<string> async_pool_disable_ssl_legacy(string session, string _pool);
        ...
        Response<string> async_pool_enable_local_storage_caching(string session, string _pool);
        ...
        Response<string> async_pool_enable_ssl_legacy(string session, string _pool);
        [XmlRpcMethod("Async.pool.get_license_state")]
        Response<string> async_pool_get_license_state(string session, string _pool);
        [XmlRpcMethod("Async.pool.has_extension")]
        Response<string> async_pool_has_extension(string session, string _pool, string _name);
        ...
        Response<string> async_pool_patch_apply(string session, string _pool_patch, string _host);
        [XmlRpcMethod("Async.pool_patch.clean")]
        Response<string> async_pool_patch_clean(string session, string _pool_patch);
        [XmlRpcMethod("Async.pool_patch.clean_on_host")]
        Response<string> async_pool_patch_clean_on_host(string session, string _pool_patch, string _host);
        [XmlRpcMethod("Async.pool_patch.destroy")]
        Response<string> async_pool_patch_destroy(string session, string _pool_patch);
        [XmlRpcMethod("Async.pool_patch.pool_apply")]
        Response<string> async_pool_patch_pool_apply(string session, string _pool_patch);
        [XmlRpcMethod("Async.pool_patch.pool_clean")]
        Response<string> async_pool_patch_pool_clean(string session, string _pool_patch);
        [XmlRpcMethod("Async.pool_patch.precheck")]
        Response<string> async_pool_patch_precheck(string session, string _pool_patch, string _host);
        ...
        Response<string> async_pool_remove_from_guest_agent_config(string session, string _pool, string _key);
        ...
        Response<string> async_pool_set_ha_host_failures_to_tolerate(string session, string _pool, string _value);
        ...
        Response<string> async_session_create_from_db_file(string session, string _filename);
        ...
        Response<string> async_tunnel_destroy(string session, string _tunnel);
        ...
        Response<string> async_vbd_assert_attachable(string session, string _vbd);
        ...
        Response<string> async_vbd_plug(string session, string _vbd);
        [XmlRpcMethod("Async.VBD.unplug")]
        Response<string> async_vbd_unplug(string session, string _vbd);
        [XmlRpcMethod("Async.VBD.unplug_force")]
        Response<string> async_vbd_unplug_force(string session, string _vbd);
        ...
        [XmlRpcMethod("Async.VDI.copy")]
        Response<string> async_vdi_copy(string session, string _vdi, string _sr, string _base_vdi, string _into_vdi);
        ...
        Response<string> async_vdi_open_database(string session, string _vdi);
        ...
        Response<string> async_vdi_read_database_pool_uuid(string session, string _vdi);
        ...
        Response<string> async_vdi_set_allow_caching(string session, string _vdi, bool _value);
        [XmlRpcMethod("Async.VDI.set_name_description")]
        Response<string> async_vdi_set_name_description(string session, string _vdi, string _value);
        [XmlRpcMethod("Async.VDI.set_name_label")]
        Response<string> async_vdi_set_name_label(string session, string _vdi, string _value);
        [XmlRpcMethod("Async.VDI.set_on_boot")]
        Response<string> async_vdi_set_on_boot(string session, string _vdi, string _value);
        ...
        [XmlRpcMethod("Async.VGPU.create")]
        Response<string> async_vgpu_create(string session, string _vm, string _gpu_group, string _device, object _other_config, string _type);
        [XmlRpcMethod("Async.VGPU.destroy")]
        Response<string> async_vgpu_destroy(string session, string _vgpu);
        [XmlRpcMethod("Async.VIF.add_ipv4_allowed")]
        Response<string> async_vif_add_ipv4_allowed(string session, string _vif, string _value);
        [XmlRpcMethod("Async.VIF.add_ipv6_allowed")]
        Response<string> async_vif_add_ipv6_allowed(string session, string _vif, string _value);
        ...
        Response<string> async_vif_plug(string session, string _vif);
        [XmlRpcMethod("Async.VIF.remove_ipv4_allowed")]
        Response<string> async_vif_remove_ipv4_allowed(string session, string _vif, string _value);
        [XmlRpcMethod("Async.VIF.remove_ipv6_allowed")]
        Response<string> async_vif_remove_ipv6_allowed(string session, string _vif, string _value);
        [XmlRpcMethod("Async.VIF.set_ipv4_allowed")]
        Response<string> async_vif_set_ipv4_allowed(string session, string _vif, string[] _value);
        [XmlRpcMethod("Async.VIF.set_ipv6_allowed")]
        Response<string> async_vif_set_ipv6_allowed(string session, string _vif, string[] _value);
        [XmlRpcMethod("Async.VIF.set_locking_mode")]
        Response<string> async_vif_set_locking_mode(string session, string _vif, string _value);
        [XmlRpcMethod("Async.VIF.unplug")]
        Response<string> async_vif_unplug(string session, string _vif);
        [XmlRpcMethod("Async.VIF.unplug_force")]
        Response<string> async_vif_unplug_force(string session, string _vif);
        ...
        Response<string> async_vlan_destroy(string session, string _vlan);
        [XmlRpcMethod("Async.VM.add_to_VCPUs_params_live")]
        Response<string> async_vm_add_to_vcpus_params_live(string session, string _vm, string _key, string _value);
        [XmlRpcMethod("Async.VM_appliance.assert_can_be_recovered")]
        Response<string> async_vm_appliance_assert_can_be_recovered(string session, string _vm_appliance, string _session_to);
        [XmlRpcMethod("Async.VM_appliance.clean_shutdown")]
        Response<string> async_vm_appliance_clean_shutdown(string session, string _vm_appliance);
        ...
        Response<string> async_vm_appliance_get_srs_required_for_recovery(string session, string _vm_appliance, string _session_to);
        [XmlRpcMethod("Async.VM_appliance.hard_shutdown")]
        Response<string> async_vm_appliance_hard_shutdown(string session, string _vm_appliance);
        [XmlRpcMethod("Async.VM_appliance.recover")]
        Response<string> async_vm_appliance_recover(string session, string _vm_appliance, string _session_to, bool _force);
        [XmlRpcMethod("Async.VM_appliance.shutdown")]
        Response<string> async_vm_appliance_shutdown(string session, string _vm_appliance);
        [XmlRpcMethod("Async.VM_appliance.start")]
        Response<string> async_vm_appliance_start(string session, string _vm_appliance, bool _paused);
        [XmlRpcMethod("Async.VM.assert_agile")]
        Response<string> async_vm_assert_agile(string session, string _vm);
        [XmlRpcMethod("Async.VM.assert_can_be_recovered")]
        Response<string> async_vm_assert_can_be_recovered(string session, string _vm, string _session_to);
        [XmlRpcMethod("Async.VM.assert_can_boot_here")]
        Response<string> async_vm_assert_can_boot_here(string session, string _vm, string _host);
        ...
        Response<string> async_vm_assert_can_set_auto_update_drivers(string session, string _vm, bool _value);
        [XmlRpcMethod("Async.VM.assert_operation_valid")]
        Response<string> async_vm_assert_operation_valid(string session, string _vm, string _op);
        [XmlRpcMethod("Async.VM.call_plugin")]
        Response<string> async_vm_call_plugin(string session, string _vm, string _plugin, string _fn, object _args);
        ...
        Response<string> async_vm_get_cooperative(string session, string _vm);
        ...
        Response<string> async_vm_get_srs_required_for_recovery(string session, string _vm, string _session_to);
        ...
        Response<string> async_vm_import(string session, string _url, string _sr, bool _full_restore, bool _force);
        ...
        Response<string> async_vm_maximise_memory(string session, string _vm, string _total, bool _approximate);
        ...
        Response<string> async_vm_query_services(string session, string _vm);
        [XmlRpcMethod("Async.VM.recover")]
        Response<string> async_vm_recover(string session, string _vm, string _session_to, bool _force);
        ...
        Response<string> async_vm_revert(string session, string _vm);
        ...
        Response<string> async_vm_set_appliance(string session, string _vm, string _value);
        [XmlRpcMethod("Async.VM.set_auto_update_drivers")]
        Response<string> async_vm_set_auto_update_drivers(string session, string _vm, bool _value);
        [XmlRpcMethod("Async.VM.set_memory_dynamic_range")]
        Response<string> async_vm_set_memory_dynamic_range(string session, string _vm, string _min, string _max);
        [XmlRpcMethod("Async.VM.set_memory_limits")]
        Response<string> async_vm_set_memory_limits(string session, string _vm, string _static_min, string _static_max, string _dynamic_min, string _dynamic_max);
        [XmlRpcMethod("Async.VM.set_memory_static_range")]
        Response<string> async_vm_set_memory_static_range(string session, string _vm, string _min, string _max);
        [XmlRpcMethod("Async.VM.set_memory_target_live")]
        Response<string> async_vm_set_memory_target_live(string session, string _vm, string _target);
        [XmlRpcMethod("Async.VM.set_order")]
        Response<string> async_vm_set_order(string session, string _vm, string _value);
        [XmlRpcMethod("Async.VM.set_shadow_multiplier_live")]
        Response<string> async_vm_set_shadow_multiplier_live(string session, string _vm, double _multiplier);
        [XmlRpcMethod("Async.VM.set_shutdown_delay")]
        Response<string> async_vm_set_shutdown_delay(string session, string _vm, string _value);
        [XmlRpcMethod("Async.VM.set_start_delay")]
        Response<string> async_vm_set_start_delay(string session, string _vm, string _value);
        [XmlRpcMethod("Async.VM.set_suspend_VDI")]
        Response<string> async_vm_set_suspend_vdi(string session, string _vm, string _value);
        [XmlRpcMethod("Async.VM.set_VCPUs_number_live")]
        Response<string> async_vm_set_vcpus_number_live(string session, string _vm, string _nvcpu);
        [XmlRpcMethod("Async.VM.shutdown")]
        Response<string> async_vm_shutdown(string session, string _vm);
        ...
        Response<string> async_vm_update_allowed_operations(string session, string _vm);
        [XmlRpcMethod("Async.VM.wait_memory_target_live")]
        Response<string> async_vm_wait_memory_target_live(string session, string _vm);
        [XmlRpcMethod("Async.VM.xenprep_abort")]
        Response<string> async_vm_xenprep_abort(string session, string _vm);
        [XmlRpcMethod("Async.VM.xenprep_start")]
        Response<string> async_vm_xenprep_start(string session, string _vm);
        ...
        Response<string> blob_destroy(string session, string _blob);
        ...
        Response<string> bond_destroy(string session, string _bond);
        ...
        Response<string> bond_set_mode(string session, string _bond, string _value);
        ...
        Response<string> bond_set_property(string session, string _bond, string _name, string _value);
        ...
        Response<string> crashdump_destroy(string session, string _crashdump);
        ...
        Response<string> dr_task_destroy(string session, string _dr_task);
        ...
        Response<string> gpu_group_create(string session, string _name_label, string _name_description, object _other_config);
        [XmlRpcMethod("GPU_group.destroy")]
        Response<string> gpu_group_destroy(string session, string _gpu_group);
        ...
        Response<string> gpu_group_get_allocation_algorithm(string session, string _gpu_group);
        ...
        Response<string[]> gpu_group_get_enabled_vgpu_types(string session, string _gpu_group);
        ...
        Response<string> gpu_group_get_remaining_capacity(string session, string _gpu_group, string _vgpu_type);
        [XmlRpcMethod("GPU_group.get_supported_VGPU_types")]
        Response<string[]> gpu_group_get_supported_vgpu_types(string session, string _gpu_group);
        ...
        Response<string> gpu_group_set_allocation_algorithm(string session, string _gpu_group, string _allocation_algorithm);
        ...
        Response<string> host_add_to_guest_vcpus_params(string session, string _host, string _key, string _value);
        ...
        [XmlRpcMethod("host.apply_edition")]
        Response<string> host_apply_edition(string session, string _host, string _edition, bool _force);
        ...
        Response<string> host_crashdump_destroy(string session, string _host_crashdump);
        ...
        Response<string> host_crashdump_upload(string session, string _host_crashdump, string _url, object _options);
        ...
        Response<string> host_declare_dead(string session, string _host);
        [XmlRpcMethod("host.destroy")]
        Response<string> host_destroy(string session, string _host);
        [XmlRpcMethod("host.disable")]
        Response<string> host_disable(string session, string _host);
        [XmlRpcMethod("host.disable_display")]
        Response<string> host_disable_display(string session, string _host);
        ...
        Response<string> host_enable_display(string session, string _host);
        ...
        Response<string> host_get_display(string session, string _host);
        ...
        Response<object> host_get_guest_vcpus_params(string session, string _host);
        ...
        Response<bool> host_get_ssl_legacy(string session, string _host);
        ...
        Response<string[]> host_get_uncooperative_resident_vms(string session, string _host);
        ...
        Response<string[]> host_get_virtual_hardware_platform_versions(string session, string _host);
        [XmlRpcMethod("host.get_vms_which_prevent_evacuation")]
        Response<object> host_get_vms_which_prevent_evacuation(string session, string _host);
        ...
        Response<string> host_patch_apply(string session, string _host_patch);
        [XmlRpcMethod("host_patch.destroy")]
        Response<string> host_patch_destroy(string session, string _host_patch);
        ...
        Response<string> host_remove_from_guest_vcpus_params(string session, string _host, string _key);
        ...
        Response<object> host_retrieve_wlb_evacuate_recommendations(string session, string _host);
        ...
        Response<string> host_set_display(string session, string _host, string _display);
        [XmlRpcMethod("host.set_guest_VCPUs_params")]
        Response<string> host_set_guest_vcpus_params(string session, string _host, object _guest_vcpus_params);
        ...
        Response<string> host_set_power_on_mode(string session, string _host, string _power_on_mode, object _power_on_config);
        [XmlRpcMethod("host.set_ssl_legacy")]
        Response<string> host_set_ssl_legacy(string session, string _host, bool _value);
        ...
        Response<string> lvhd_enable_thin_provisioning(string session, string _sr, string _initial_allocation, string _allocation_quantum);
        [XmlRpcMethod("LVHD.get_all_records")]
        Response<object> lvhd_get_all_records(string session);
        [XmlRpcMethod("LVHD.get_by_uuid")]
        Response<string> lvhd_get_by_uuid(string session, string _uuid);
        [XmlRpcMethod("LVHD.get_record")]
        Response<Proxy_LVHD> lvhd_get_record(string session, string _lvhd);
        [XmlRpcMethod("LVHD.get_uuid")]
        Response<string> lvhd_get_uuid(string session, string _lvhd);
        ...
        Response<string> message_destroy(string session, string _message);
        ...
        Response<Proxy_Message> message_get_record(string session, string _message);
        ...
        Response<object> network_get_assigned_ips(string session, string _network);
        ...
        Response<string> pbd_plug(string session, string _pbd);
        ...
        Response<string> pbd_set_device_config(string session, string _pbd, object _value);
        ...
        Response<string> pbd_unplug(string session, string _pbd);
        ...
        Response<string> pci_get_subsystem_device_name(string session, string _pci);
        [XmlRpcMethod("PCI.get_subsystem_vendor_name")]
        Response<string> pci_get_subsystem_vendor_name(string session, string _pci);
        ...
        Response<string> pgpu_add_enabled_vgpu_types(string session, string _pgpu, string _value);
        ...
        Response<string> pgpu_disable_dom0_access(string session, string _pgpu);
        [XmlRpcMethod("PGPU.enable_dom0_access")]
        Response<string> pgpu_enable_dom0_access(string session, string _pgpu);
        ...
        Response<string> pgpu_get_dom0_access(string session, string _pgpu);
        [XmlRpcMethod("PGPU.get_enabled_VGPU_types")]
        Response<string[]> pgpu_get_enabled_vgpu_types(string session, string _pgpu);
        ...
        Response<bool> pgpu_get_is_system_display_device(string session, string _pgpu);
        ...
        Response<string> pgpu_get_remaining_capacity(string session, string _pgpu, string _vgpu_type);
        [XmlRpcMethod("PGPU.get_resident_VGPUs")]
        Response<string[]> pgpu_get_resident_vgpus(string session, string _pgpu);
        [XmlRpcMethod("PGPU.get_supported_VGPU_max_capacities")]
        Response<object> pgpu_get_supported_vgpu_max_capacities(string session, string _pgpu);
        [XmlRpcMethod("PGPU.get_supported_VGPU_types")]
        Response<string[]> pgpu_get_supported_vgpu_types(string session, string _pgpu);
        ...
        Response<string> pgpu_remove_enabled_vgpu_types(string session, string _pgpu, string _value);
        ...
        Response<string> pgpu_set_enabled_vgpu_types(string session, string _pgpu, string[] _value);
        [XmlRpcMethod("PGPU.set_GPU_group")]
        Response<string> pgpu_set_gpu_group(string session, string _pgpu, string _value);
        ...
        Response<string> pif_db_forget(string session, string _pif);
        ...
        Response<string> pif_destroy(string session, string _pif);
        [XmlRpcMethod("PIF.forget")]
        Response<string> pif_forget(string session, string _pif);
        ...
        Response<string[]> pif_get_capabilities(string session, string _pif);
        ...
        Response<bool> pif_get_managed(string session, string _pif);
        ...
        Response<object> pif_get_properties(string session, string _pif);
        ...
        [XmlRpcMethod("PIF.introduce")]
        Response<string> pif_introduce(string session, string _host, string _mac, string _device, bool _managed);
        ...
        Response<string> pif_plug(string session, string _pif);
        [XmlRpcMethod("PIF.reconfigure_ip")]
        Response<string> pif_reconfigure_ip(string session, string _pif, string _mode, string _ip, string _netmask, string _gateway, string _dns);
        [XmlRpcMethod("PIF.reconfigure_ipv6")]
        Response<string> pif_reconfigure_ipv6(string session, string _pif, string _mode, string _ipv6, string _gateway, string _dns);
        ...
        Response<string> pif_set_primary_address_type(string session, string _pif, string _primary_address_type);
        [XmlRpcMethod("PIF.set_property")]
        Response<string> pif_set_property(string session, string _pif, string _name, string _value);
        [XmlRpcMethod("PIF.unplug")]
        Response<string> pif_unplug(string session, string _pif);
        ...
        Response<string> pool_add_to_guest_agent_config(string session, string _pool, string _key, string _value);
        ...
        Response<string> pool_add_to_health_check_config(string session, string _pool, string _key, string _value);
        ...
        Response<string> pool_apply_edition(string session, string _pool, string _edition);
        ...
        Response<string> pool_disable_local_storage_caching(string session, string _pool);
        ...
        Response<string> pool_disable_ssl_legacy(string session, string _pool);
        ...
        Response<string> pool_enable_local_storage_caching(string session, string _pool);
        ...
        Response<string> pool_enable_ssl_legacy(string session, string _pool);
        ...
        Response<string[]> pool_get_allowed_operations(string session, string _pool);
        ...
        Response<object> pool_get_current_operations(string session, string _pool);
        ...
        Response<object> pool_get_guest_agent_config(string session, string _pool);
        ...
        Response<string> pool_get_ha_cluster_stack(string session, string _pool);
        ...
        Response<object> pool_get_health_check_config(string session, string _pool);
        [XmlRpcMethod("pool.get_license_state")]
        Response<object> pool_get_license_state(string session, string _pool);
        ...
        Response<bool> pool_has_extension(string session, string _pool, string _name);
        ...
        Response<string> pool_patch_apply(string session, string _pool_patch, string _host);
        [XmlRpcMethod("pool_patch.clean")]
        Response<string> pool_patch_clean(string session, string _pool_patch);
        [XmlRpcMethod("pool_patch.clean_on_host")]
        Response<string> pool_patch_clean_on_host(string session, string _pool_patch, string _host);
        [XmlRpcMethod("pool_patch.destroy")]
        Response<string> pool_patch_destroy(string session, string _pool_patch);
        ...
        Response<string> pool_patch_pool_apply(string session, string _pool_patch);
        [XmlRpcMethod("pool_patch.pool_clean")]
        Response<string> pool_patch_pool_clean(string session, string _pool_patch);
        [XmlRpcMethod("pool_patch.precheck")]
        Response<string> pool_patch_precheck(string session, string _pool_patch, string _host);
        ...
        Response<string> pool_remove_from_guest_agent_config(string session, string _pool, string _key);
        ...
        Response<string> pool_remove_from_health_check_config(string session, string _pool, string _key);
        ...
        Response<string> pool_set_ha_host_failures_to_tolerate(string session, string _pool, string _value);
        [XmlRpcMethod("pool.set_health_check_config")]
        Response<string> pool_set_health_check_config(string session, string _pool, object _health_check_config);
        ...
        Response<string> pool_test_archive_target(string session, string _pool, object _config);
        ...
        Response<string[]> role_get_by_permission(string session, string _role);
        ...
        Response<string[]> role_get_permissions(string session, string _role);
        [XmlRpcMethod("role.get_permissions_name_label")]
        Response<string[]> role_get_permissions_name_label(string session, string _role);
        ...
        Response<string> session_create_from_db_file(string session, string _filename);
        ...
        Response<string> session_get_originator(string session, string _session);
        ...
        Response<string> session_login_with_password(string _uname, string _pwd);
        [XmlRpcMethod("session.login_with_password")]
        Response<string> session_login_with_password(string _uname, string _pwd, string _version);
        [XmlRpcMethod("session.login_with_password")]
        Response<string> session_login_with_password(string _uname, string _pwd, string _version, string _originator);
        ...
        Response<object> sm_get_features(string session, string _sm);
        ...
        Response<string[]> sm_get_required_cluster_stack(string session, string _sm);
        ...
        Response<string> sr_forget_data_source_archives(string session, string _sr, string _data_source);
        ...
        Response<bool> sr_get_clustered(string session, string _sr);
        ...
        Response<Proxy_Data_source[]> sr_get_data_sources(string session, string _sr);
        ...
        Response<double> sr_query_data_source(string session, string _sr, string _data_source);
        [XmlRpcMethod("SR.record_data_source")]
        Response<string> sr_record_data_source(string session, string _sr, string _data_source);
        ...
        Response<string> sr_set_physical_size(string session, string _sr, string _value);
        [XmlRpcMethod("SR.set_physical_utilisation")]
        Response<string> sr_set_physical_utilisation(string session, string _sr, string _value);
        ...
        Response<string> sr_set_virtual_allocation(string session, string _sr, string _value);
        [XmlRpcMethod("SR.update")]
        Response<string> sr_update(string session, string _sr);
        [XmlRpcMethod("subject.add_to_roles")]
        Response<string> subject_add_to_roles(string session, string _subject, string _role);
        ...
        Response<string[]> subject_get_permissions_name_label(string session, string _subject);
        ...
        Response<string> subject_remove_from_roles(string session, string _subject, string _role);
        ...
        Response<string> task_destroy(string session, string _task);
        ...
        Response<string> task_get_backtrace(string session, string _task);
        ...
        Response<string> tunnel_destroy(string session, string _tunnel);
        ...
        Response<string> vbd_assert_attachable(string session, string _vbd);
        ...
        Response<string> vbd_plug(string session, string _vbd);
        ...
        Response<string> vbd_unplug(string session, string _vbd);
        [XmlRpcMethod("VBD.unplug_force")]
        Response<string> vbd_unplug_force(string session, string _vbd);
        ...
        [XmlRpcMethod("VDI.copy")]
        Response<string> vdi_copy(string session, string _vdi, string _sr, string _base_vdi, string _into_vdi);
        ...
        Response<string> vdi_open_database(string session, string _vdi);
        ...
        Response<string> vdi_read_database_pool_uuid(string session, string _vdi);
        ...
        Response<string> vdi_set_allow_caching(string session, string _vdi, bool _value);
        [XmlRpcMethod("VDI.set_is_a_snapshot")]
        Response<string> vdi_set_is_a_snapshot(string session, string _vdi, bool _value);
        [XmlRpcMethod("VDI.set_managed")]
        Response<string> vdi_set_managed(string session, string _vdi, bool _value);
        [XmlRpcMethod("VDI.set_metadata_of_pool")]
        Response<string> vdi_set_metadata_of_pool(string session, string _vdi, string _value);
        [XmlRpcMethod("VDI.set_missing")]
        Response<string> vdi_set_missing(string session, string _vdi, bool _value);
        [XmlRpcMethod("VDI.set_name_description")]
        Response<string> vdi_set_name_description(string session, string _vdi, string _value);
        [XmlRpcMethod("VDI.set_name_label")]
        Response<string> vdi_set_name_label(string session, string _vdi, string _value);
        [XmlRpcMethod("VDI.set_on_boot")]
        Response<string> vdi_set_on_boot(string session, string _vdi, string _value);
        ...
        Response<string> vdi_set_physical_utilisation(string session, string _vdi, string _value);
        [XmlRpcMethod("VDI.set_read_only")]
        Response<string> vdi_set_read_only(string session, string _vdi, bool _value);
        [XmlRpcMethod("VDI.set_sharable")]
        Response<string> vdi_set_sharable(string session, string _vdi, bool _value);
        ...
        Response<string> vdi_set_snapshot_of(string session, string _vdi, string _value);
        [XmlRpcMethod("VDI.set_snapshot_time")]
        Response<string> vdi_set_snapshot_time(string session, string _vdi, DateTime _value);
        ...
        Response<string> vdi_set_virtual_size(string session, string _vdi, string _value);
        ...
        [XmlRpcMethod("VGPU.create")]
        Response<string> vgpu_create(string session, string _vm, string _gpu_group, string _device, object _other_config, string _type);
        [XmlRpcMethod("VGPU.destroy")]
        Response<string> vgpu_destroy(string session, string _vgpu);
        ...
        Response<string> vgpu_get_resident_on(string session, string _vgpu);
        [XmlRpcMethod("VGPU.get_type")]
        Response<string> vgpu_get_type(string session, string _vgpu);
        ...
        Response<string[]> vgpu_type_get_all(string session);
        [XmlRpcMethod("VGPU_type.get_all_records")]
        Response<object> vgpu_type_get_all_records(string session);
        [XmlRpcMethod("VGPU_type.get_by_uuid")]
        Response<string> vgpu_type_get_by_uuid(string session, string _uuid);
        [XmlRpcMethod("VGPU_type.get_enabled_on_GPU_groups")]
        Response<string[]> vgpu_type_get_enabled_on_gpu_groups(string session, string _vgpu_type);
        [XmlRpcMethod("VGPU_type.get_enabled_on_PGPUs")]
        Response<string[]> vgpu_type_get_enabled_on_pgpus(string session, string _vgpu_type);
        [XmlRpcMethod("VGPU_type.get_experimental")]
        Response<bool> vgpu_type_get_experimental(string session, string _vgpu_type);
        [XmlRpcMethod("VGPU_type.get_framebuffer_size")]
        Response<string> vgpu_type_get_framebuffer_size(string session, string _vgpu_type);
        [XmlRpcMethod("VGPU_type.get_identifier")]
        Response<string> vgpu_type_get_identifier(string session, string _vgpu_type);
        [XmlRpcMethod("VGPU_type.get_implementation")]
        Response<string> vgpu_type_get_implementation(string session, string _vgpu_type);
        [XmlRpcMethod("VGPU_type.get_max_heads")]
        Response<string> vgpu_type_get_max_heads(string session, string _vgpu_type);
        [XmlRpcMethod("VGPU_type.get_max_resolution_x")]
        Response<string> vgpu_type_get_max_resolution_x(string session, string _vgpu_type);
        [XmlRpcMethod("VGPU_type.get_max_resolution_y")]
        Response<string> vgpu_type_get_max_resolution_y(string session, string _vgpu_type);
        [XmlRpcMethod("VGPU_type.get_model_name")]
        Response<string> vgpu_type_get_model_name(string session, string _vgpu_type);
        [XmlRpcMethod("VGPU_type.get_record")]
        Response<Proxy_VGPU_type> vgpu_type_get_record(string session, string _vgpu_type);
        [XmlRpcMethod("VGPU_type.get_supported_on_GPU_groups")]
        Response<string[]> vgpu_type_get_supported_on_gpu_groups(string session, string _vgpu_type);
        [XmlRpcMethod("VGPU_type.get_supported_on_PGPUs")]
        Response<string[]> vgpu_type_get_supported_on_pgpus(string session, string _vgpu_type);
        [XmlRpcMethod("VGPU_type.get_uuid")]
        Response<string> vgpu_type_get_uuid(string session, string _vgpu_type);
        [XmlRpcMethod("VGPU_type.get_vendor_name")]
        Response<string> vgpu_type_get_vendor_name(string session, string _vgpu_type);
        [XmlRpcMethod("VGPU_type.get_VGPUs")]
        Response<string[]> vgpu_type_get_vgpus(string session, string _vgpu_type);
        [XmlRpcMethod("VIF.add_ipv4_allowed")]
        Response<string> vif_add_ipv4_allowed(string session, string _vif, string _value);
        [XmlRpcMethod("VIF.add_ipv6_allowed")]
        Response<string> vif_add_ipv6_allowed(string session, string _vif, string _value);
        ...
        Response<string> vif_plug(string session, string _vif);
        ...
        Response<string> vif_remove_ipv4_allowed(string session, string _vif, string _value);
        [XmlRpcMethod("VIF.remove_ipv6_allowed")]
        Response<string> vif_remove_ipv6_allowed(string session, string _vif, string _value);
        [XmlRpcMethod("VIF.set_ipv4_allowed")]
        Response<string> vif_set_ipv4_allowed(string session, string _vif, string[] _value);
        [XmlRpcMethod("VIF.set_ipv6_allowed")]
        Response<string> vif_set_ipv6_allowed(string session, string _vif, string[] _value);
        [XmlRpcMethod("VIF.set_locking_mode")]
        Response<string> vif_set_locking_mode(string session, string _vif, string _value);
        ...
        Response<string> vif_unplug(string session, string _vif);
        [XmlRpcMethod("VIF.unplug_force")]
        Response<string> vif_unplug_force(string session, string _vif);
        ...
        Response<string> vlan_destroy(string session, string _vlan);
        ...
        Response<string> vm_add_to_vcpus_params_live(string session, string _vm, string _key, string _value);
        ...
        Response<string> vm_appliance_assert_can_be_recovered(string session, string _vm_appliance, string _session_to);
        [XmlRpcMethod("VM_appliance.clean_shutdown")]
        Response<string> vm_appliance_clean_shutdown(string session, string _vm_appliance);
        ...
        Response<string[]> vm_appliance_get_srs_required_for_recovery(string session, string _vm_appliance, string _session_to);
        ...
        Response<string> vm_appliance_hard_shutdown(string session, string _vm_appliance);
        [XmlRpcMethod("VM_appliance.recover")]
        Response<string> vm_appliance_recover(string session, string _vm_appliance, string _session_to, bool _force);
        ...
        Response<string> vm_appliance_shutdown(string session, string _vm_appliance);
        [XmlRpcMethod("VM_appliance.start")]
        Response<string> vm_appliance_start(string session, string _vm_appliance, bool _paused);
        [XmlRpcMethod("VM.assert_agile")]
        Response<string> vm_assert_agile(string session, string _vm);
        [XmlRpcMethod("VM.assert_can_be_recovered")]
        Response<string> vm_assert_can_be_recovered(string session, string _vm, string _session_to);
        [XmlRpcMethod("VM.assert_can_boot_here")]
        Response<string> vm_assert_can_boot_here(string session, string _vm, string _host);
        ...
        Response<string> vm_assert_can_set_auto_update_drivers(string session, string _vm, bool _value);
        [XmlRpcMethod("VM.assert_operation_valid")]
        Response<string> vm_assert_operation_valid(string session, string _vm, string _op);
        [XmlRpcMethod("VM.call_plugin")]
        Response<string> vm_call_plugin(string session, string _vm, string _plugin, string _fn, object _args);
        ...
        Response<string> vm_forget_data_source_archives(string session, string _vm, string _data_source);
        ...
        Response<bool> vm_get_auto_update_drivers(string session, string _vm);
        ...
        Response<Proxy_VM> vm_get_boot_record(string session, string _vm);
        ...
        Response<bool> vm_get_cooperative(string session, string _vm);
        ...
        Response<Proxy_Data_source[]> vm_get_data_sources(string session, string _vm);
        ...
        Response<string> vm_get_generation_id(string session, string _vm);
        ...
        Response<string> vm_get_hardware_platform_version(string session, string _vm);
        ...
        Response<string[]> vm_get_srs_required_for_recovery(string session, string _vm, string _session_to);
        ...
        Response<bool> vm_guest_metrics_get_network_paths_optimized(string session, string _vm_guest_metrics);
        ...
        Response<bool> vm_guest_metrics_get_storage_paths_optimized(string session, string _vm_guest_metrics);
        ...
        Response<string[]> vm_import(string session, string _url, string _sr, bool _full_restore, bool _force);
        ...
        Response<string> vm_maximise_memory(string session, string _vm, string _total, bool _approximate);
        ...
        Response<double> vm_query_data_source(string session, string _vm, string _data_source);
        [XmlRpcMethod("VM.query_services")]
        Response<object> vm_query_services(string session, string _vm);
        [XmlRpcMethod("VM.record_data_source")]
        Response<string> vm_record_data_source(string session, string _vm, string _data_source);
        [XmlRpcMethod("VM.recover")]
        Response<string> vm_recover(string session, string _vm, string _session_to, bool _force);
        ...
        Response<string> vm_revert(string session, string _vm);
        ...
        Response<string> vm_set_appliance(string session, string _vm, string _value);
        [XmlRpcMethod("VM.set_auto_update_drivers")]
        Response<string> vm_set_auto_update_drivers(string session, string _vm, bool _value);
        ...
        Response<string> vm_set_ha_always_run(string session, string _vm, bool _value);
        [XmlRpcMethod("VM.set_ha_restart_priority")]
        Response<string> vm_set_ha_restart_priority(string session, string _vm, string _value);
        [XmlRpcMethod("VM.set_hardware_platform_version")]
        Response<string> vm_set_hardware_platform_version(string session, string _vm, string _hardware_platform_version);
        ...
        Response<string> vm_set_hvm_shadow_multiplier(string session, string _vm, double _value);
        ...
        Response<string> vm_set_memory_dynamic_max(string session, string _vm, string _value);
        [XmlRpcMethod("VM.set_memory_dynamic_min")]
        Response<string> vm_set_memory_dynamic_min(string session, string _vm, string _value);
        [XmlRpcMethod("VM.set_memory_dynamic_range")]
        Response<string> vm_set_memory_dynamic_range(string session, string _vm, string _min, string _max);
        [XmlRpcMethod("VM.set_memory_limits")]
        Response<string> vm_set_memory_limits(string session, string _vm, string _static_min, string _static_max, string _dynamic_min, string _dynamic_max);
        [XmlRpcMethod("VM.set_memory_static_max")]
        Response<string> vm_set_memory_static_max(string session, string _vm, string _value);
        [XmlRpcMethod("VM.set_memory_static_min")]
        Response<string> vm_set_memory_static_min(string session, string _vm, string _value);
        [XmlRpcMethod("VM.set_memory_static_range")]
        Response<string> vm_set_memory_static_range(string session, string _vm, string _min, string _max);
        [XmlRpcMethod("VM.set_memory_target_live")]
        Response<string> vm_set_memory_target_live(string session, string _vm, string _target);
        ...
        Response<string> vm_set_order(string session, string _vm, string _value);
        ...
        Response<string> vm_set_protection_policy(string session, string _vm, string _value);
        ...
        Response<string> vm_set_shadow_multiplier_live(string session, string _vm, double _multiplier);
        [XmlRpcMethod("VM.set_shutdown_delay")]
        Response<string> vm_set_shutdown_delay(string session, string _vm, string _value);
        [XmlRpcMethod("VM.set_start_delay")]
        Response<string> vm_set_start_delay(string session, string _vm, string _value);
        ...
        Response<string> vm_set_suspend_vdi(string session, string _vm, string _value);
        ...
        Response<string> vm_set_vcpus_at_startup(string session, string _vm, string _value);
        [XmlRpcMethod("VM.set_VCPUs_max")]
        Response<string> vm_set_vcpus_max(string session, string _vm, string _value);
        [XmlRpcMethod("VM.set_VCPUs_number_live")]
        Response<string> vm_set_vcpus_number_live(string session, string _vm, string _nvcpu);
        ...
        Response<string> vm_shutdown(string session, string _vm);
        ...
        Response<string> vm_update_allowed_operations(string session, string _vm);
        [XmlRpcMethod("VM.wait_memory_target_live")]
        Response<string> vm_wait_memory_target_live(string session, string _vm);
        [XmlRpcMethod("VM.xenprep_abort")]
        Response<string> vm_xenprep_abort(string session, string _vm);
        [XmlRpcMethod("VM.xenprep_start")]
        Response<string> vm_xenprep_start(string session, string _vm);
        [XmlRpcMethod("VMPP.add_to_alarm_config")]
        Response<string> vmpp_add_to_alarm_config(string session, string _vmpp, string _key, string _value);
        [XmlRpcMethod("VMPP.add_to_archive_schedule")]
        Response<string> vmpp_add_to_archive_schedule(string session, string _vmpp, string _key, string _value);
        [XmlRpcMethod("VMPP.add_to_archive_target_config")]
        Response<string> vmpp_add_to_archive_target_config(string session, string _vmpp, string _key, string _value);
        [XmlRpcMethod("VMPP.add_to_backup_schedule")]
        Response<string> vmpp_add_to_backup_schedule(string session, string _vmpp, string _key, string _value);
        ...
        Response<string> vmpp_remove_from_alarm_config(string session, string _vmpp, string _key);
        [XmlRpcMethod("VMPP.remove_from_archive_schedule")]
        Response<string> vmpp_remove_from_archive_schedule(string session, string _vmpp, string _key);
        [XmlRpcMethod("VMPP.remove_from_archive_target_config")]
        Response<string> vmpp_remove_from_archive_target_config(string session, string _vmpp, string _key);
        [XmlRpcMethod("VMPP.remove_from_backup_schedule")]
        Response<string> vmpp_remove_from_backup_schedule(string session, string _vmpp, string _key);
        [XmlRpcMethod("VMPP.set_alarm_config")]
        Response<string> vmpp_set_alarm_config(string session, string _vmpp, object _value);
        [XmlRpcMethod("VMPP.set_archive_frequency")]
        Response<string> vmpp_set_archive_frequency(string session, string _vmpp, string _value);
        [XmlRpcMethod("VMPP.set_archive_last_run_time")]
        Response<string> vmpp_set_archive_last_run_time(string session, string _vmpp, DateTime _value);
        [XmlRpcMethod("VMPP.set_archive_schedule")]
        Response<string> vmpp_set_archive_schedule(string session, string _vmpp, object _value);
        [XmlRpcMethod("VMPP.set_archive_target_config")]
        Response<string> vmpp_set_archive_target_config(string session, string _vmpp, object _value);
        [XmlRpcMethod("VMPP.set_archive_target_type")]
        Response<string> vmpp_set_archive_target_type(string session, string _vmpp, string _value);
        [XmlRpcMethod("VMPP.set_backup_frequency")]
        Response<string> vmpp_set_backup_frequency(string session, string _vmpp, string _value);
        [XmlRpcMethod("VMPP.set_backup_last_run_time")]
        Response<string> vmpp_set_backup_last_run_time(string session, string _vmpp, DateTime _value);
        [XmlRpcMethod("VMPP.set_backup_retention_value")]
        Response<string> vmpp_set_backup_retention_value(string session, string _vmpp, string _value);
        [XmlRpcMethod("VMPP.set_backup_schedule")]
        Response<string> vmpp_set_backup_schedule(string session, string _vmpp, object _value);
        ...
        Response<string> vmpp_set_is_alarm_enabled(string session, string _vmpp, bool _value);
